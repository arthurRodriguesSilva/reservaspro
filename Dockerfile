...
# Instala dependências necessárias para o Laravel e o PostgreSQL
...
# Cria automaticamente o arquivo .env temporário
...
# Copia a configuração personalizada do Apache que vamos criar abaixo
